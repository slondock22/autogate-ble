...
--
-- Host: localhost    Database: db_gatesble
-- ------------------------------------------------------
...
CREATE TABLE `trucks` (
  ...
  `bidang_perusahaan` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `users` VALUES (1,'Administrator','admin@gmail.com',NULL,'$2y$10$Uo0SHD2cfpocWrmrlKxdO.vJrmQhdf5ODNM.j4jsYqmQ0BNHFRLsO',NULL,'2019-09-01 10:03:24','2019-09-01 10:03:24');
/*!40000 ALTER TABLE `users` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'db_gatesble'
--
